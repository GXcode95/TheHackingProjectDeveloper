class Morpion {
	...
	constructor(firstPlayer = 'J1',recursion=0) {
		this.humanPlayer = firstPlayer;
		this.iaPlayer = (firstPlayer === 'J1') ? 'J2' : 'J1';
		this.recusion = recursion |
		console.log("original => ", this.recursion)
		if (!recursion)  {
	...
	getBestMove() {
		let gameCp = new Morpion("J1", 1)
		gameCp.iaPlayer = "J2"
		gameCp.firstPlayer = "J2"
		gameCp.recursion = true
		console.log(gameCp.recursion)
		gameCp.gridMap = this.gridMap.map(cell => cell)

		


		
		console.log(this.gridMap[0][0])
		console.log(gameCp.gridMap[0][0])
		console.log(gameCp.gridMap[0][0] = "K")
		console.log("ici" , this.gridMap[0][0])
		console.log(gameCp.gridMap[0][0])
